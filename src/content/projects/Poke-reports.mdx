...
- ⚙️ Desplegar toda la aplicación en Azure sin errores: Desde asegurar que las dependencias de Python estuvieran bien definidas hasta resolver conflictos entre WSL2, Docker y Azure CLI, el despliegue completo fue un verdadero rompecabezas. Tuve que investigar bastante, reiniciar servicios varias veces y aplicar soluciones como wsl --shutdown y SCOPE_IDENTITY() en SQL Server para evitar registros erróneos.
